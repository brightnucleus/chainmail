    ...
    public function mailCreationDataProvider()
    {
        return [
            ...
            [
                ...
                'BrightNucleus\ChainMail\Template\BasicTemplate',
            ],
            [
                'text',
                'BasicTemplate',
            ...
            [
                ...
                'HeroTemplate',
                'BrightNucleus\ChainMail\Mail\HTMLMail',
                'BrightNucleus\ChainMail\Template\HeroTemplate',
            ],
            [
                'text',
                'HeroTemplate',
            ...
            [
                ...
                'SidebarTemplate',
                'BrightNucleus\ChainMail\Mail\HTMLMail',
                'BrightNucleus\ChainMail\Template\SidebarTemplate',
            ],
            [
                'text',
                'SidebarTemplate',
            ...
            [
                ...
                'HeroSidebarTemplate',
                'BrightNucleus\ChainMail\Mail\HTMLMail',
                'BrightNucleus\ChainMail\Template\HeroSidebarTemplate',
            ],
            [
                'text',
                'HeroSidebarTemplate',
